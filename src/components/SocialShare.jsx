...
const SocialShare = ({ event, isEventCreator }) => {
  ...
  if (!event.isPublic && !isEventCreator) {
    return null;
  }
  ...
  return (
    <div className="social-sharing" style={{ marginBottom: '2rem', padding: '1.5rem', backgroundColor: '#f8f9fa', borderRadius: '8px', border: '1px solid #e9ecef' }}>
      ...
      <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap', alignItems: 'center' }}>
        ...
        >
          <i className="fa-brands fa-square-twitter"/> Twitter
        </button>
        <button 
        ...
        >
          <i className="fa-brands fa-square-whatsapp"/> WhatsApp
        </button>
        <button 
